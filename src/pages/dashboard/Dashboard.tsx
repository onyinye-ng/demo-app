          ...
          {giftCard.map((card) => {
            return (
              <Link
                key={card.id}
                to={{
                  pathname: `/dashboard/cardDetails`,
                }}
                state={{ card_detail: card }}
                className="block bg-primary-dark lg:w-120 w-150 h-48 ... md:h-48 ... lg:h-48 ...  p-5 max-w-sm rounded-lg shadow-md hover:bg-gray-100"
              >
